...
const LoginWrapper: React.FC<LoginWrapperProps>  = () => {
    ...
    return (
        <div className='align-items-center align-middle my-auto'>
            ...
            <button onClick={()=>{window.location.href = 'https://github.com/login/oauth/authorize?client_id=9765e58690fb0cd32bd4&scope=user:email%20read:user';}} className='btn btn-primary'>Login with Github</button>
